	...
	obj.html(
		'<div class="plupload_wrapper">' +
			'<div class="ui-widget-content plupload_container">' +
				'<div class="ui-state-default ui-widget-header plupload_header" style="display:none">' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' + _('파일명') + '</td>' +
					'<td class="plupload_cell plupload_file_status">' + _('상태') + '</td>' +
					'<td class="plupload_cell plupload_file_size">' + _('사이즈') + '</td>' +
					'<td class="plupload_cell plupload_file_action">&nbsp;</td>' +
				'</tr>' +
				'</table>' +

				'<div class="plupload_content">' +
					'<div class="plupload_droptext">' + _("파일을 선택하세요") + '</div>' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' +
						'<div class="plupload_buttons"><!-- Visible -->' +
							//'<a class="plupload_button plupload_add">' + _("파일추가") + '</a>&nbsp;' +
							'<a class="plupload_button plupload_add"></a>&nbsp;' +
