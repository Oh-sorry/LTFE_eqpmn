...
public class EgovAltibaseClobStringTypeHandler extends AbstractLobTypeHandler {

	private static final Logger LOGGER = LoggerFactory.getLogger(EgovAltibaseClobStringTypeHandler.class);
	 ...
	 */
	public EgovAltibaseClobStringTypeHandler() {
		super();
	}
	 ...
	 */
	protected EgovAltibaseClobStringTypeHandler(LobHandler lobHandler) {
		super(lobHandler);
	}
